  ...
  return (
    ...
    <div className='mt-5'>
      <div className='search-box p-2 mb-2 text-center'>
        <input type="text" name="search" id="search" className='py-2 px-3 border focus:outline-none lg:w-6/12 mb-4 w-full' onChange={e=> setSearchText(e.target.value)}/>
        <button onClick={handleSearch} className='bg-blue text-white font-semibold px-8 py-2 mb-4 rounded-sm '>search</button>
